...
/******** IO port definitions **************/
#define GCN64_BIT_NUM_S	"7" // for asm
#define FREQ_IS_16MHZ	1
...
static unsigned char gcn64_receive2()
{
...
"			pop r30				\n" // restore z
		...
		: 	"z" ((unsigned char volatile *)gcn64_workbuf),		// %1
			"I" (_SFR_IO_ADDR(GCN64_DATA_PIN2)),	// %2
...
"sb_wait_high_done%=:\n"
	:
	: "I" (_SFR_IO_ADDR(GCN64_DATA_DDR2)), // %0
	  "w" (bits),						// %1
	  "z" ((unsigned char volatile *)gcn64_workbuf),					// %2
	  "I" (_SFR_IO_ADDR(GCN64_DATA_PIN2))	// %3
	: "r16", "r17");
}
 ...
 *
 **/
static void gcn64_decodeWorkbuf2(unsigned char count)
{
	unsigned char i;
...
unsigned char gcn64_protocol_getByte2(int offset)
{
	unsigned char val, b;
